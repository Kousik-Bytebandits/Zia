    ...
    <footer className="bg-[#111111] text-white px-4 md:px-6 py-12 font-sans">
      <div className="max-w-[90%] xxxl:max-w-[80%] mx-auto space-y-10">
        ...
        <div className="flex flex-col laptop:flex-row justify-between laptop:items-start gap-10">
          ...
          {/* Logo & Address */}
          <div className="text-center laptop:text-left space-y-4 laptop:w-[320px]">
            <img
          ...
          <div className="flex flex-wrap  justify-between lg:w-[65%] lg:mt-14 font-archivo">
            {/* Useful Links */}
            <div className="mt-6 space-y-3 min-w-[110px]">
              <h3 className="text-[20px] laptop:text-[17px] hd:text-[18px] xxxl:text-[20px] font-semibold mb-2">Useful links</h3>
            ...
            {/* Customer Care */}
            <div className="mt-6 space-y-3 min-w-[150px]">
              <h3 className="text-[20px] laptop:text-[17px] hd:text-[18px] xxxl:text-[20px] font-semibold mb-2">Customer Care</h3>
            ...
            {/* Policies */}
            <div className="space-y-3 mt-6 min-w-[150px]">
              <h3 className="text-[20px] laptop:text-[17px] hd:text-[18px] xxxl:text-[20px] font-semibold mb-2">Policies</h3>
              <ul className="space-y-2 text-[16px] text-white">
            ...
            {/* About */}
            <div className="space-y-3 mt-6 min-w-[130px]">
              <h3 className="text-[20px] laptop:text-[17px] hd:text-[18px] xxxl:text-[20px] font-semibold mb-2">About</h3>
              <ul className="space-y-2 text-[16px] text-white">
                <li>Our Story</li>
                <li>Our Mission</li>
                <li>Our Vision</li>
            ...
            {/* Info */}
            <div className="mt-6 space-y-3 min-w-[130px]">
              <h3 className="text-[20px] laptop:text-[17px] hd:text-[18px] xxxl:text-[20px] font-semibold mb-2">Info</h3>
              <ul className="space-y-2 text-[16px]  text-white">
