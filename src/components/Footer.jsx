...
Guindy, Chennai - 600 032., Tamilnadu`}
          ...
          <div className="flex  flex-row sm:flex-row justify-around gap-10 lg:gap-40 text-center lg:text-left">
            ...
            <div className="lg:mt-8 space-y-4">
              ...
              <ul className="space-y-3 text-[16px] font-archivo lg:text-[16px] text-left">
                <li>
                  <Link to="/shoplist" className="hover:underline hover:text-[#00FF94] transition-all duration-200">
                    Skin Care
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/ordertracking" className="hover:underline hover:text-[#00FF94] transition-all duration-200">
                    Track Order
                  </Link>
                </li>
              </ul>
            ...
            <div className="lg:mt-8 space-y-4">
              ...
              <ul className="space-y-3 text-[15px] lg:text-[16px] text-left ">
                <li>
                  <Link to="/about" className="hover:underline  hover:text-[#00FF94] transition-all duration-200">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/contactus" className="hover:underline hover:text-[#00FF94] transition-all duration-200">
                    Contact Us
                  </Link>
                </li>
              </ul>
          ...
          <div className="lg:mt-8 font-archivo  text-center lg:text-left space-y-4 order-last lg:order-none">
            <h3 className="text-[18px] lg:text-[20px]">Contact Us</h3>
