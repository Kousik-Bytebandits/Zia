...
export default function AboutUs(){
  ...
  const handleMore =()=>{
    ...
    <div className=" space-y-6 pt-4 text-center lg:text-left lg:max-w-[45%] lg:pt-[4%]">
      ...
      <div className="text-[32px] hidden  lg:block font-tenor tracking-[0.2em] leading-snug uppercase text-[#676A5E] space-y-1">
        <p>EMBRAce the unseen magic</p>
        <p>of facial touchup</p>
      </div>
      ...
      <p className="hidden lg:block text-[14px] lg:text-[16px] lg:hidden text-[#676A5E] font-archivo  lg:w-[100%] leading-relaxed">
      ...
      <p className="hidden lg:block text-[14px] lg:text-[16px] text-[#676A5E] font-archivo  lg:w-[100%] leading-relaxed">Creation timelines for the standard lorem ipsum passage vary, with some citing the 15th century and others the 20th. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque.</p>

<p className="text-[14px] lg:text-[16px] text-[#676A5E] font-archivo  lg:w-[100%] leading-relaxed">It's difficult to find examples of lorem ipsum in use before Letraset made it popular as a dummy text in the 1960s, although McClintock says he remembers coming across the lorem ipsum passage in a book of old metal type samples. So far he hasn't relocated where he once saw the passage, but the popularity of Cicero in the 15th century supports the theory that the filler text has been used for centuries.</p>  
      ...
      <div className="flex justify-between text-[14px] lg:text-[16px] font-archivo text-[#676A5E] pt-4 ">
        <div className="text-center lg:flex lg:items-center lg:gap-4 lg:mb-20">
          <img src="images/drops.png" alt="Icon 1" className="mx-auto mb-2   lg:mb-0 lg:w-[75px] lg:h-[75px]" />
          <div className="lg:text-left ">
            <p>Required Enamel</p>
            <p>Solutions</p>
          </div>
        </div>
        <div className="text-center lg:hidden lg:flex lg:items-center lg:gap-4 lg:mb-20">
          <img src="images/hold.png" alt="Icon 2" className="mx-auto mb-2   lg:mb-0 lg:w-[75px] lg:h-[75px]" />
          <div className="lg:text-left">
        ...
        <div className="text-center lg:flex lg:items-center lg:gap-4 lg:mb-20">
          <img src="images/leaf.png" alt="Icon 3" className="mx-auto mb-2   lg:mb-0 lg:w-[75px] lg:h-[75px]" />
          <div className="lg:text-left">
            <p>Organic Natural</p>
            <p>Products</p>
          </div>
        </div>
         <div className="hidden lg:block text-center lg:flex lg:items-center lg:gap-4 lg:mb-20">
          <div className="border rounded-full border-[#B2BA98] w-[75px] h-[75px] flex items-center justify-center">
            <img src="images/fs.png" alt="Icon 4" className="   lg:mb-0 lg:w-[50px] lg:h-[55px]" />
  </div>
                  <div className="lg:text-left">
            <p>Stunning Solutions</p>
            <p>in Face</p>
      ...
      <div className="text-center lg:text-left font-tenor order-last lg:order-none">
        ...
        <button className="bg-black text-white px-6 py-3 mb-10 rounded-full text-[14px] mt-5">
    ...
    <div className="relative w-full  lg:w-[720px] pt-18">
    ...
    <section className="w-full bg-white py-10 px-4 lg:px-20">

      {/* ✅ MOBILE VIEW */}
      <div className="pt-10 p-4 space-y-4 text-center lg:hidden">
        <div className="font-tenor text-center text-[#676A5E] py-8 mx-auto">
      ...
      <div className="hidden lg:flex flex-col items-center text-center relative">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-[16px] lg:w-[80%] lg:ml-16 text-[#676A5E] font-archivo mb-6 lg:mb-12">
            Creation timelines for the standard lorem ipsum passage vary, with some citing the 15th century and others the 20th. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque.
          </p>
          <h3 className="text-[18px] lg:text-[24px] font-tenor uppercase tracking-[0.2em] text-[#5E5E5E] leading-relaxed mb-8">
            Our Philosophy Revolves<br />
            The Idea That Each Individual<br />
            Uniqu Products
          </h3>
          <button className="bg-black text-white px-6 py-3 rounded-full text-[14px] mb-16">
            Discover More <span className="text-lg ml-3">→</span>
          </button>
        </div>

        {/* Images with Curved Lines */}
        <div className="relative w-full max-w-6xl flex justify-between items-start">
          ...
          <div className="flex flex-col items-center">
            <img
              src="/images/massageoil.png"
              alt="Massage Oil"
              className="w-[270px] h-auto z-10 mr-[50%] -mt-[100%]"
            />
          </div>
          ...
          <img
            src="/images/left.png"
            alt="Left Curve Line"
            className="absolute left-[10%] top-[40%] w-[300px]"
          />

          {/* Center Product (Lowered for U-shape) */}
          <div className="flex flex-col items-center mt-16">
            <img
              src="/images/green1.png"
              alt="Hair Shampoo"
              className="w-[270px] h-auto z-10 "
            />
          </div>
          ...
          <img
            ...
            alt="Right Curve Line"
            className="absolute right-[10%] top-[40%] w-[300px]"
          />
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              alt="Hair Oil"
              className="w-[270px] h-auto z-10 ml-[50%] -mt-[100%]"
            />
          </div>
        </div>
      </div>
...
<div className="font-archivo lg:mt-80">
  ...
  <div className="lg:flex lg:h-[100vh] mx-auto py-16 lg:space-x-12 text-[#676A5E] space-y-10 lg:space-y-0 items-center lg:bg-[#2B452C] lg:text-white  lg:px-0">
    ...
    <div className="relative lg:w-1/2 px-4">
      <img
        src="images/face.png"
        alt="Before and After"
        className="lg:z-10 relative border-gray-400 lg:-top-80 lg:w-[850px] lg:h-[640px] rounded-lg shadow-2xl lg:left-20"
      />
      <span className="absolute top-2/3 left-5 lg:top-1/3 lg:left-40 lg:z-10  transform -translate-y-1/2 text-[#313131] text-[22px]">Before</span>
      <span className="absolute top-2/3 right-5  lg:top-1/3 lg:right-20 lg:z-10 transform -translate-y-1/2 text-[#313131] text-[22px]">After</span>
    </div>
